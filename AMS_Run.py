...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name = r'C:\Users\jvsri\OneDrive\Desktop\Attendace_management_system/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            c1ear_enroll = tk.Button(MFW, text="Clear", command=remove_enr, fg="black", bg="cyan", width=10,
                                     height=1,
                                     activebackground="Red", font=('times', 15, ' bold '))
            c1ear_enroll.place(x=690, y=100)

            c1ear_student = tk.Button(MFW, text="Clear", command=remove_student, fg="black", bg="cyan", width=10,
                                      height=1,
                                      activebackground="Red", font=('times', 15, ' bold '))
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\jvsri\OneDrive\Desktop\Attendace_management_system\Manually Attendance\-------Check atttendance-------"')

            attf = tk.Button(MFW,  text=" Sheets",command=attf,fg="black"  ,bg="lawn green"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('times', 14, ' bold '))
    ...
    fill_manual_attendance = tk.Button(sb, text="Fill Attendance",command=fill_attendance, fg="white", bg="cyan", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = r'C:\Users\jvsri\OneDrive\Desktop\Attendace_management_system' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\jvsri\OneDrive\Desktop\Attendace_management_system\Attendance\-------Check atttendance-------"')
    ...
    fill_a = tk.Button(windo, text="Fill Attendance", fg="white",command=Fillattendances, bg="cyan", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'admin' :
            if password == 'password':
                ...
                cs = r'C:\Users\jvsri\OneDrive\Desktop\Attendace_management_system\StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
    ...
    c0 = tk.Button(win, text="Clear", command=c00, fg="black", bg="cyan", width=10, height=1,
                            activebackground="Red", font=('times', 15, ' bold '))
    c0.place(x=690, y=55)

    c1 = tk.Button(win, text="Clear", command=c11, fg="black", bg="cyan", width=10, height=1,
                   activebackground="Red", font=('times', 15, ' bold '))
...
message = tk.Label(window, text="Attendance Management System FR", bg="cyan", fg="black", width=50,
...
lbl = tk.Label(window, text="Enter Student ID", width=20, height=2, fg="black", bg="cyan", font=('times', 15, ' bold '))
...
txt = tk.Entry(window, validate="key", width=20, bg="grey", fg="black", font=('times', 25, ' bold '))
txt['validatecommand'] = (txt.register(testVal),'%P','%d')
txt.place(x=550, y=210)

lbl2 = tk.Label(window, text="Enter Stu Name", width=20, fg="black", bg="cyan", height=2, font=('times', 15, ' bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, bg="grey", fg="black", font=('times', 25, ' bold '))
...
AP = tk.Button(window, text="Check Registered students",command=admin_panel,fg="black"  ,bg="cyan"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
